...
SECRET_KEY = 'django-insecure-yrnbw8ju&ox*unp3$rfiuj)l1t9z&5=*vols=i^k0com$zt!hx'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.nav_items',
            ],
        },
    },
]
...
TELEBIRR_APP_KEY = os.getenv("TELEBIRR_APP_KEY")
...
EMAIL_HOST_PASSWORD = 'vwqo wvhy tjts yrfm'
